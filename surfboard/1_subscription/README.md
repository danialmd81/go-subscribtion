...
> **Caution:** Managed config must be defined in the first line of the profile
...
> **Caution:** Currently Surfboard will ignore `strict` param definition and treat it like `false`
